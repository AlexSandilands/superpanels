...
Concise list of functionality, UI surfaces, and workflows for the profile-management redesign. Implementation-agnostic; intended as input to a UI design tool.
